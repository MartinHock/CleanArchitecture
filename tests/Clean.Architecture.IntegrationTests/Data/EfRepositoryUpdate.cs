...
public class EfRepositoryUpdate : BaseEfRepoTestFixture
{
  ...
  public async Task UpdatesItemAfterAddingIt()
  {
    ...
    // Update the item
    await repository.UpdateAsync(newContributor, TestContext.Current.CancellationToken);

    // Fetch the updated item
    var updatedItem = (await repository.ListAsync(TestContext.Current.CancellationToken))
